.PHONY: help test lighthouse axe ci preflight test-dryrun
...
help:
	...
	@echo "  make preflight    - Test preflight checks workflow locally"
...
preflight:
	@act -W .github/workflows/preflight.yml $(ACT_FLAGS)
